...
// Assign data-scroll data attribute to all anchor links
$('a[href^="#"]').attr('data-scroll', '');



// Assign a styling class to the navigation bar when scrolled past a certain point
$(window).scroll(function() {
    if($(this).scrollTop() > 0) {
        $('.navbar-uniqul').addClass('navbar--opaque');
    } else {
        $('.navbar-uniqul').removeClass('navbar--opaque');
    }
});
...
smoothScroll.init({
    speed: 415, // Integer. How fast to complete the scroll in milliseconds
...
// Hide FAQ answers and reveal them by toggle
$(".js-faq-entry__answer").hide();
$('.js-faq-entry__question').click(function () {
...
// Add placeholder attribute to Gravity Forms field
jQuery('input[name$="input_1"]').attr('placeholder','Your email address');




// Close the mobile view of navigation bar when clicking on one of the links within
$(".navbar-uniqul li a").click(function(event) {
    // check if window is small enough so dropdown is created
    $(".navbar-collapse").removeClass("in").addClass("collapse");
    // remove the menu toggled class if clicked on a nav link
    $(".navbar-uniqul").removeClass("menu-toggled");
});
...
// Apply a background color class to navigation bar if clicked on mobile..
$(".navbar-toggle").click(function(event) {
    $(".navbar-uniqul").toggleClass("menu-toggled");
});




// Remove the error message classes from the Gravity Forms elements
// Would benefit from a hook that actually watched when they appear
...
// Check if the user arrives on the page at a section other than the landing page.
